...
export const AdminGetKycListAPI = endpoint("/admin/kyc");
export const AdminGetAgentKycAPI = (AGENT_ID) => endpoint(`/admin/agents/${AGENT_ID}/kyc`);
export const AdminApproveKycAPI = (AGENT_ID) => endpoint(`/admin/agents/${AGENT_ID}/kyc/approve`);
export const AdminRejectKycAPI = (AGENT_ID) => endpoint(`/admin/agents/${AGENT_ID}/kyc/reject`);
